...
class TestDecode(unittest.TestCase):
    ...
    def test_encode_decode(self):
        ...
        # Remember that the offset field is signed!
        # If your test case gives you a large integer
        # value like 1012 instead of the expected value
        # -12, it's probably because you forgot to use
        # xtract_signed in place of extract.
